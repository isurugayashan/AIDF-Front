    ...
    <>
        <div className="relative min-h-screen">
            <Hero/>
                ...
                <div className=" bg-cover bg-center absolute top-0 left-0  w-full h-full object-cover -z-10" 
                    ...
                    backgroundImage: `url('https://images.pexels.com/photos/338504/pexels-photo-338504.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')`}}>
                </div>
        </div>
        <HotelListings/> 
        <SignUpCallToAction />
